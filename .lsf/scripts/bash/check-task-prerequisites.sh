...
if [[ ! -d "$FEATURE_DIR" ]]; then echo "ERROR: Feature directory not found: $FEATURE_DIR"; echo "Run /epic first."; exit 1; fi
if [[ ! -f "$FEATURE_BREAKDOWN" ]]; then echo "ERROR: breakdown.md not found in $FEATURE_DIR"; echo "Run /breakdown first."; exit 1; fi
if $JSON_MODE; then
